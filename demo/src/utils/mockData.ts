...
export const inviteRecords: InviteRecord[] = [
  { id: 'r1', who: '用户 0xA3F2', time: '2026-03-30 16:21', status: '已注册', reward: '+30 积分' },
  { id: 'r2', who: '用户 0x19D8', time: '2026-03-29 20:04', status: '已下单', reward: '+1 抖音钻石包' },
  { id: 'r3', who: '用户 0x4C11', time: '2026-03-28 11:39', status: '已完成', reward: '+80 积分' },
];
