...
import { ArrowLeft, Loader2, Package, ShoppingBag, X } from "lucide-react";
...
export default function OrdersPage() {
  ...
  const filtered = useMemo(() => {
    ...
    if (tab === "used") return orders.filter((o) => o.status === "COMPLETED" || o.status === "CANCELLED" || o.status === "REFUNDED");
    return orders;
  }, [orders, tab]);
